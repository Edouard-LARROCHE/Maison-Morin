...
const Cocktails = () => {
    ...
    return (
        ...
        <div className="Infos-enterText">
            <h1>COCKTAILS</h1>
            <p className='Presentation-macarons'>Vous recevez des amis à manger chez vous? Vous organisez un anniversaire surprise? Un baptême? Ou simplement envie de vous faire plaisir?
            Maison Maurin vous propose un large choix de canapés traiteur, petits fours de l'entrée au dessert pour vos apérititfs signés Victorien Morin et partager un moment de 
            convivialité en toute tranquilité. 
            </p>
        </div>     
        </div>
