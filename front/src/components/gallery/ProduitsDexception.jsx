...
const ProduitsDexception = () => {
  ...
  return (
    <>
      ...
      <p>
        Maison Morin vous propose son Saumon écossais fumé au bois de hêtre, un saumon ?? à chair ??? ?? et ferme avec des notes douces et dorées, un équilibre idéal, disponible
