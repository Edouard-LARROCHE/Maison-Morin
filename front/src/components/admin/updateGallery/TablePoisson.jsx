...
const TablePoisson = (props) => {
  ...
  const handleSubmitPost = async (e) => {
    ...
    await axios
      .post('/picture/traiteur/poisson', poissonPostCard)
      .then((res) => {
  ...
  const handleSubmitUpdate = async (e) => {
    ...
    await axios
      .put(`/picture/traiteur/poisson/${id}`, currentCard)
      .then((res) => {
        console.log(res.data);
        setEditing(false);
      })
      ...
      {editing ? (
        ...
        <div>
          ...
          <form onSubmit={handleSubmitPost}>
            <input type='text' placeholder='Photo URL' name='pictureUrl' value={poissonPostCard.pictureUrl} onChange={handleChangePost} />

            <input type='text' placeholder='Nom' name='name' value={poissonPostCard.name} onChange={handleChangePost} />

            <textarea type='text' placeholder='Description' name='price' value={poissonPostCard.price} onChange={handleChangePost} />
