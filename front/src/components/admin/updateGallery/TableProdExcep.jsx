      ...
      {editing ? (
        ...
        <div>
          ...
          <form onSubmit={handleSubmitPost}>
            <input type='text' placeholder='Photo URL' name='pictureUrl' value={prodExcepPostCard.pictureUrl} onChange={handleChangePost} />

            <input type='text' placeholder='Nom' name='name' value={prodExcepPostCard.name} onChange={handleChangePost} />

            <textarea type='text' placeholder='Description' name='price' value={prodExcepPostCard.price} onChange={handleChangePost} />
