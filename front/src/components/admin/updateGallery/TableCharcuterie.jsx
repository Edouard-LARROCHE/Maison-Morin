...
const TableCharcuterie = (props) => {
  ...
  const handleSubmitPost = async (e) => {
    ...
    await axios
      .post('/picture/traiteur/charcuterie', charcuteriePostCard)
      .then((res) => {
  ...
  const handleSubmitUpdate = async (e) => {
    ...
    await axios
      .put(`/picture/traiteur/charcuterie/${id}`, currentCard)
      .then((res) => {
        console.log(res.data);
        setEditing(false);
      })
      ...
      {editing ? (
        ...
        <div>
          ...
          <form onSubmit={handleSubmitPost}>
            ...
            <textarea type='text' placeholder='Description' name='price' value={charcuteriePostCard.price} onChange={handleChangePost} />
