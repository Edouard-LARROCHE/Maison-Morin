  ...
  return (
    <div className='user-traces'>
      ...
      <p>
        ...
        Maison Morin, qui s’engage à n’en faire aucune autre utilisation. Vous pouvez vous opposer à l’enregistrement de ces cookies en configurant le
        navigateur installé sur votre système, pour être averti de l’arrivée d’un cookie et pour pouvoir le refuser.
      </p>
    </div>
  );
};
